...
class SyncObjectComment
{
     ...
     * @param int $rate
     */
    public function __construct(int $syncStatusDateTime, string $objID, string $linkedObjID, ?string $type, ?string $userID, ?array $images, ?array $tags, int $date, ?string $content, int $rate)
    {
