 ...
 */
class getTripUserRoleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TripUserRoleRepository' shared autowired service.
     *
     * @return \App\Repository\TripUserRoleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TripUserRoleRepository.php';

        return $container->privates['App\\Repository\\TripUserRoleRepository'] = new \App\Repository\TripUserRoleRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
