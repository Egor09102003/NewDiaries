 ...
 */
class getSecurity_User_Provider_Concrete_ApiTokenProviderService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.api_token_provider' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.api_token_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($container->services['doctrine'] ?? $container->load('getDoctrineService')), 'App\\Entity\\User', 'username', NULL);
    }
}
