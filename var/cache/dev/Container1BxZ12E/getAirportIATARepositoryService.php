 ...
 */
class getAirportIATARepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AirportIATARepository' shared autowired service.
     *
     * @return \App\Repository\AirportIATARepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AirportIATARepository.php';

        return $container->privates['App\\Repository\\AirportIATARepository'] = new \App\Repository\AirportIATARepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
