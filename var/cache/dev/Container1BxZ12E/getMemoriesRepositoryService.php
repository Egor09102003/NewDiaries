 ...
 */
class getMemoriesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MemoriesRepository' shared autowired service.
     *
     * @return \App\Repository\MemoriesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MemoriesRepository.php';

        return $container->privates['App\\Repository\\MemoriesRepository'] = new \App\Repository\MemoriesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
