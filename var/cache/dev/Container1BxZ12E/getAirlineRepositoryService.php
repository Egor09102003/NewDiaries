 ...
 */
class getAirlineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AirlineRepository' shared autowired service.
     *
     * @return \App\Repository\AirlineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AirlineRepository.php';

        return $container->privates['App\\Repository\\AirlineRepository'] = new \App\Repository\AirlineRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
