 ...
 */
class getEPickerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EPickerRepository' shared autowired service.
     *
     * @return \App\Repository\EPickerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EPickerRepository.php';

        return $container->privates['App\\Repository\\EPickerRepository'] = new \App\Repository\EPickerRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
