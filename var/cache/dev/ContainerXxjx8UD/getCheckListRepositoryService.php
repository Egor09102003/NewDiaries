...
class getCheckListRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CheckListRepository.php';

        return $container->privates['App\\Repository\\CheckListRepository'] = new \App\Repository\CheckListRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
