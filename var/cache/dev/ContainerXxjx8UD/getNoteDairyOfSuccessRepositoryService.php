 ...
 */
class getNoteDairyOfSuccessRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NoteDairyOfSuccessRepository' shared autowired service.
     *
     * @return \App\Repository\NoteDairyOfSuccessRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NoteDairyOfSuccessRepository.php';

        return $container->privates['App\\Repository\\NoteDairyOfSuccessRepository'] = new \App\Repository\NoteDairyOfSuccessRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
