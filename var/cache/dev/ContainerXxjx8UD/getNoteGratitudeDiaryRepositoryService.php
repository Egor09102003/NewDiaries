 ...
 */
class getNoteGratitudeDiaryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NoteGratitudeDiaryRepository' shared autowired service.
     *
     * @return \App\Repository\NoteGratitudeDiaryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NoteGratitudeDiaryRepository.php';

        return $container->privates['App\\Repository\\NoteGratitudeDiaryRepository'] = new \App\Repository\NoteGratitudeDiaryRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
