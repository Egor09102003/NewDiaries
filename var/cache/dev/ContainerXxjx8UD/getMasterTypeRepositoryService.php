 ...
 */
class getMasterTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MasterTypeRepository' shared autowired service.
     *
     * @return \App\Repository\MasterTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MasterTypeRepository.php';

        return $container->privates['App\\Repository\\MasterTypeRepository'] = new \App\Repository\MasterTypeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
