 ...
 */
class getLocationAutocompleteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Modules\LocationAutocomplete\LocationAutocompleteRepository' shared autowired service.
     *
     * @return \App\Modules\LocationAutocomplete\LocationAutocompleteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Modules'.\DIRECTORY_SEPARATOR.'LocationAutocomplete'.\DIRECTORY_SEPARATOR.'LocationAutocompleteRepository.php';

        return $container->privates['App\\Modules\\LocationAutocomplete\\LocationAutocompleteRepository'] = new \App\Modules\LocationAutocomplete\LocationAutocompleteRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
